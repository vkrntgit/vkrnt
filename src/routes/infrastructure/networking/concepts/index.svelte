...
<h3>301 and 302 redirects</h3>
A 301 redirect is a status code that tells users and search engine that the page
has moved permanently. A 302 redirect is used for temporary redirects. More<a
  href="https://www.domain.com/blog/what-is-a-redirect/">here</a
>.
<br /><br /><br />
<h3>NAT'ing (NATting)</h3>
...
unregistered IP addresses, but then converting to globally unique.<br />
<br /><br /><br />
<h3>netem (linux)</h3>
What is netem? netem stands for Network Emulator. This is a tool in linux to emulate
packet loss, network delays, duplication.<a
  href="https://wiki.linuxfoundation.org/networking/netem">Reference.</a
>
<br /><br /><br />
